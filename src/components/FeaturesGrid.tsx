...
export function FeaturesGrid({ lang }: { lang: Language }) {
  ...
  const copy = lang === "zh"
    ? [
        ...
        ["Plan 批准", "Plan → approve / refine · Ask / Workspace / Full · OS 沙箱"],
        ["@ 引用", "AGENTS.md · Skills · MCP · @file · Hooks"],
      ]
    : [
        ...
        ["Plan approve", "Plan → approve / refine · Ask / Workspace / Full · OS sandbox"],
        ["@ mentions", "AGENTS.md · Skills · MCP · @file · Hooks"],
      ];
